...
with open("train.csv", 'r') as file:
    reviews = list(csv.reader(file)) # csv.reader me da un objeto iterador de cada línea del file, al aplicarle list, me da una lista de lineas.
   # Cada línea ya es una lista (son varias columnas)
...
def make_class_prediction(text, counts, class_prob, class_count):
    prediction = 1
    text_counts = Counter(re.split("\s+", text)) # Metenos en un diccionario las palabras y su cantidad de apariciones.
