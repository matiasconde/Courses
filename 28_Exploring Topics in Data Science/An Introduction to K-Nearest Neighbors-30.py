...
def euclidean_distance(serie1):
    differences_sqr = 0
    for k in distance_columns:
        differences_sqr += (serie1[k] - selected_player[k])**2
    return (differences_sqr)**0.5
...
most_similar_to_lebron = nba.iloc[most_similar_to_lebron_index]
...
mse = (((actual-predictions)**2).sum()) / len(test)