...
for i in range(len(checker_board)):
    for j in range(len(checker_board[0])):
...
boston_population -= 1
beijing_population = city_populations["Beijing"] + 1

city_populations["Boston"] = boston_population
city_populations["Beijing"] = beijing_population
