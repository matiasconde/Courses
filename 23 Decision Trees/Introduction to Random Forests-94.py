...
roc = roc_auc_score(test["high_income"],pred)
roc2 = roc_auc_score(test["high_income"],pred2)
...
pred3 = np.round((predictions+predictions2)/2)

roc = roc_auc_score(test["high_income"],pred3)
...
final_prediction_ensemble = numpy.round(sum(predictions)/10)

roc = roc_auc_score(test["high_income"],final_prediction_ensemble)
print(roc)
...
print(roc_auc_score(train["high_income"],predictions1))
