...
degrees_zero = [32+459.67,64+459.67,78+459.67,102+459.67]
...
dic = {"none":0,"a few":1,"some":2,"a lot":3}
...
average_smoking = suma/len(survey_responses)
...
sum_female, sum_male, cont_female,cont_male = 0, 0, 0, 0
...
male_savings = sum_male / cont_male
female_savings = sum_female / cont_female
...
mean = new_titanic_survival["age"].mean()
plt.axvline(median, color="g")
