...
# Performing the mean of the scores in different areas.
(88 + 87.66667 + 86 + 91.33333 + 84 + 91 + 89.33333)/7 # simple average calculation
...
final_scores <- c(math,chemistry,writing,art,history,music,89.33333)
