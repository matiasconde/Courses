...
scores = cross_val_score(estimator=knn,X=all_X,y=all_y,cv=10)
...
scores = cross_val_score(estimator=rfc,X=all_X,y=all_y,cv=10)
...
hyperparameters = {"criterion":["entropy","gini"],"max_depth":[5,10],"max_features":["log2","sqrt"],"min_samples_leaf":[1,5],"min_samples_split":[3,5],"n_estimators":[6,9]}
...
holdout_predictions = best_rfc.predict(holdout_no_id)

submissions_dict = {"PassengerId":holdout["PassengerId"],"Survived":holdout_predictions}
