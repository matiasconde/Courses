...
for i in theta1s:
    y.append(cost(100,i,pga["distance"],pga["accuracy"]))
...
for i in range(100):
    for j in range(100):
        COST[i,j] = cost(TO[0,i],T1[j,0],pga["distance"],pga["accuracy"])
  
fig2 = plt.figure()
ax2 = fig2.gca(projection="3d")
ax2.plot_surface(X=T0,Y=T1,Z=COST)
plt.show()
...
y = gradient_descent(pga["distance"],pga["accuracy"],alpha=0.01)["costs"]
