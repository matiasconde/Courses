...
string = "White {0}, pale {1}"

first_line = string.format("hat","skin")
...
final2 = mad_libs.format(ADJ="strong",NOUN="piano",AGE="99",NOUN_PLURAL="phones", VERB="smash",LOCATION="Antarctica",CELEBRITY="Beyonce")

print(len(final), len(final2))